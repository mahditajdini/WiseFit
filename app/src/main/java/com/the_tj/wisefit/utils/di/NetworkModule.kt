...
import com.the_tj.wisefit.utils.BASE_URL
import com.the_tj.wisefit.utils.NETWORK_TIMEOUT
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideRetrofit(baseUrl: String, client: OkHttpClient, gson: Gson): OpenAiService =
        Retrofit.Builder()
            .baseUrl(baseUrl)
            .client(client)
